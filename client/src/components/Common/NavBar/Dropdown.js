...
function Dropdown({ data }) {
    return (
        ...
        <li className='font-bold text-blue-900 hover:underline p-1 bg-transparent '>
            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center justify-between w-full font-bold text-blue-900 hover:underline px-3 bg-transparent transition duration-300 ease-in-out transform hover:scale-110">{data.title}
