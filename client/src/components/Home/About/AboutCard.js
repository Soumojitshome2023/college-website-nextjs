            ...
            <section className="text-gray-600 body-font soumojitanibox">
                <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                        <img className="object-cover object-center rounded" alt="hero" src="/collegepic(1).jpg" />
                    </div>
            ...
            <section className="text-gray-600 body-font soumojitanibox">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                        <img className="object-cover object-center rounded" alt="hero" src="/collegepic(2).jpg" />
                    </div>
                </div>
            </section>
        </>
