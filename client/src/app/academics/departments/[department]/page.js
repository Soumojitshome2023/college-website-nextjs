				...
				<div className='flex flex-row'>
					...
					<div className='flex md:ml-56 flex-col justify-center items-center w-full'>
						<div className=' w-full lg:h-80 overflow-hidden flex justify-center items-center '>
							<img class="w-full rounded-lg" src={QueryDepartmentData.BannerPic} alt="image description" />
						</div>
						<h1 class="w-full p-2 text-lg font-extrabold leading-none tracking-tight lg:text-3xl text-white text-center  bg-red-950">{QueryDepartmentData.PageRouteData.DepartmentName}</h1>
